...
def generate_launch_description():
    ...
    # EKF: fuses wheel odometry + IMU into /odometry/filtered and the odom->base_footprint TF
    ekf_config = os.path.join(pkg_path, 'config', 'simulation', 'ekf.yaml')
    ekf_node = Node(
    ...
    # Lane geometry: road_top width=1.068m, centre divider at Y=2.534.
    #   Inner lane centre: lane_y=2.267   Outer lane centre: lane_y=2.801
    ...
    npc_nodes = [
        # Both NPCs share the robot's inner lane (y=2.267); robot spawns at arc~7.0.
        npc(1, 2.267, 9.5),
        npc(2, 2.267, 20.0),
    ]
